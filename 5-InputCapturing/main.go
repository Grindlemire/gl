...
func main() {
	...
	_ = NewModel(program, "model")
	camera = NewCamera(program, "view", mgl32.Vec3{0, 0, 5}, mgl32.Vec3{0, 0, -1}, mgl32.Vec3{0, 1, 0})
...
func initGlfw() (window *glfw.Window, err error) {
	...
	window.SetCursorPosCallback(HandleCursorMove)
